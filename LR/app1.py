...
if Model == 'Uzupełnianie danych':
    ...
    rc.markdown("<h1 style='text-align: center;size = 5; color: black;'>Wykres przedstawia sprzedaż ilościową Gripexu Hot wraz z linią trendu.</h1>", unsafe_allow_html=True)
